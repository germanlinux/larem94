...
router.get('/depot/dotation', controller_depots.dotation);
router.post('/depot/dotation', controller_depots.dotation_projet);
router.get('/produit_list', controller_produits.liste);
router.post('/produit_list', controller_produits.produit_add);
router.post('/comites/dotation', controller_comites.dotation);
